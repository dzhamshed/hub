<template>
  <div>
    <div style="width: 68%; height: 70%; border: 1px solid #000; position: absolute; left: 10px; top: 10px;">
      <!--<h2>{{ title1 }}</h2>-->
    ...
    <div style="width: 29%; height: 65%; border: 1px solid #000; position: absolute; overflow-y: scroll; right: 10px; bottom: 10px;">
      <!--<h2>{{ title3 }}</h2>-->
